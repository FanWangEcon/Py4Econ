...
# 2. box width: see pyfan\style.css for body width, set width to bodywidth - 225
if (knitr::is_latex_output()) {
...
if(!is.null(spt_file_current)) {
  ...
  if (st_file_wno_suffix == 'Data-Structures-and-Cloud-Services-with-Python') {
    bl_own_file <- FALSE
    text_shared_preamble_one <- paste0("> Go back to [fan](http://fanwangecon.github.io/)'s [Python Code Examples](https://fanwangecon.github.io/Py4Econ/) Repository ([bookdown site](https://fanwangecon.github.io/Py4Econ/bookdown)) or the [pyfan](https://pyfan.readthedocs.io/en/latest/) Package ([API](https://pyfan.readthedocs.io/en/latest/reference.html)).")
  } else {
    text_shared_preamble_one <- paste0(st_head_link, " Go back to [Python Code Examples](https://fanwangecon.github.io/Py4Econ/) Repository ([bookdown site](https://fanwangecon.github.io/Py4Econ/bookdown)) or the [pyfan](https://pyfan.readthedocs.io/en/latest/) Package ([API](https://pyfan.readthedocs.io/en/latest/reference.html)).")
  }
}
